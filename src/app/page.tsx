                ...
                >
                  <div className="relative z-10">
                    <div className="flex items-center gap-3">
                      <span className={`text-2xl font-bold ${uni.textColor}`}>
                        {uni.shortName}
                      </span>
          ...
          <div className="rounded-xl border border-slate-800/50 bg-slate-900/30 p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-400">
              <li className="flex gap-3">
                ...
                <span>
                  Add your courses — assessment items are loaded automatically
              ...
              <li className="flex gap-3">
                ...
                <span>
                  Enter your marks as percentages or fractions (e.g. 17/20)
                </span>
              </li>
              <li className="flex gap-3">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-800 text-xs font-medium text-slate-300">
                ...
                <span>
                  See what you need on remaining items to hit your target grade
                </span>
              </li>
            </ul>
          </div>
